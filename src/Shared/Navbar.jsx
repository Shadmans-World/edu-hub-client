    ...
    <div className="bg-base-200 sticky top-0 z-10">
     ...
     <div className="navbar-start">
       ...
       <Link to="/">
        ...
        <Link to="/" className="  text-xl font-bold hidden lg:block">
        EduHub <span className="text-xl font-bold bg-gradient-to-r from-green-600 to-red-500 bg-clip-text text-transparent">Bangla</span>
        </Link>
       </div>
      </div>
